...
const EventCard: React.FC<EventCardProps> = ({ event, userId }) => {
  ...
  const handleBookingConfirm = async (selectedSeats: Seat[]) => {
    ...
    const response = await axios.post('https://book-my-show-webapp.onrender.com/bookingseat', bookingData);
  ...
  const handleDelete = async () => {
    try {
      if (confirm('Are you sure you want to delete this event?')) {
        await axios.get(`https://book-my-show-webapp.onrender.com/deleteEvent/${event.eventid}`);
